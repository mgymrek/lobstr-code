...
// prefix: reference path prefix
// fn_fa: fastq file with reads -> change to read container TODO
// opt: all the options
// Change how output written: add fields to reads in read container
// with boolean saying if aligned or not, hopefully other alignment stats
