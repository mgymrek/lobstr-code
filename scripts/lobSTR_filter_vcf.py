...
if __name__ == "__main__":
    ...
    parser.add_argument("--loc-max-ref-length", help="Min max reference length of a locus to include", type=int, default=10000)
    ...
    parser.add_argument("--call-cov", help="Min coverage to include a locus", type=int, default=0)
